          ...
          var option = $.extend(defaults, options);
            ...
            return this.each(function() {
		      ...
		      //alert(e);
                    ...
                    vwrap = $('.vwrap');
                    core = '<div class="vbox-overlay ' + extraCss + '" style="background:'+ overlayColor +'"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="vbox-content"></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-close" onclick="return initializemarquee();">X</div><div class="vbox-next">next</div><div class="vbox-prev">prev</div></div>';
