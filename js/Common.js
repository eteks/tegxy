...
function searchResult(searchKey,selectarea,type2,requestType){
	...
	var data ="action=Add&searchkey="+searchKey+"&requesttype="+requestType+"&usercity="+userCity+"&userarea="+userArea+"&type2="+type2+"&usersector="+usersector; //data
     $.ajax({ 
	  type: 'POST',
	  url: url,
	  data: data,
...
function bestdealresult(searchkey,prodservice,selectarea,type2){
   ...
   // alert(searchResult);
    ...
    var url = "include/BlModules/Bl_SearchResults.php"; //url
	var data ="action=Add&searchkey="+searchKey+"&requesttype="+requestType+"&usercity="+userCity+"&userarea="+userArea+"&type2="+type2+"&prodservice="+prodservice; //data
     $.ajax({ 
	  type: 'POST',
	  url: url,
	  data: data,
...
function searchResult1(searchKey,selectarea,type2,id){
    ...
    var url = "include/BlModules/Bl_SearchResults.php"; //url
	var data ="action=Add&searchkey="+searchKey+"&requesttype="+requestType+"&usercity="+userCity+"&userarea="+userArea+"&type2="+type2+"&startdata="+id; //data
     $.ajax({ 
	  type: 'POST',
	  url: url,
	  data: data,
...
function selectcity(type2){
  ...
  //alert(requestType);
     var url = "include/BlModules/Bl_SearchList.php"; //url
	var data ="action=3&searchkey="+searchkey+"&requesttype="+requestType+"&type2="+type2; //data
     $.ajax({ 
	  type: 'POST',
	  url: url,
	  data: data,
	  success: function(data){
             // alert(data);
              $("#sourceselectcity").html(data);
		}
	}); 
    
}

function selectsector(type2){
   //alert("entersector");
   var searchkey = $("#searchlist").val(); 
   var requestType=$("input[name='requestType']:checked").val();
  ...
  //alert(requestType);
     var url = "include/BlModules/Bl_SearchList.php"; //url
	var data ="action=4&searchkey="+searchkey+"&requesttype="+requestType+"&type2="+type2; //data
     $.ajax({ 
	  type: 'POST',
	  url: url,
	  data: data,
